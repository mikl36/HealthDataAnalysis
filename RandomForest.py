...
# Splitting the dataset into the Training set and Test set 20-80 shuffle=False
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2,
                                                    random_state=0)

# Training the Random Forest Classification model
model = ensemble.RandomForestClassifier(max_depth=9, criterion='gini') # max_depth = 5
...
plt.title("Confusion Matrix, New Values, RF")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.show()
